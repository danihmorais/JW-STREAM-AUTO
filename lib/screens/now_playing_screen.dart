      ...
      body: SafeArea(
        child: StreamBuilder<int?>(
          ...
          builder: (context, _) {
            ...
            // Android Automotive/Auto head units are often much shorter
            // (and wider) than a phone screen. The fixed-size album art +
            // slider + controls below used to overflow on those screens
            // since the Column had no scroll fallback. LayoutBuilder +
            // SingleChildScrollView + IntrinsicHeight lets the two Spacers
            // shrink to zero and the content scroll instead of overflowing,
            // while keeping the same centered look on normal phone screens.
                        ...
                        child: Column(
                          children: [
                            ...
                            ClipRRect(
                              ...
                              child: song != null &&
                                      (song.coverUrl?.isNotEmpty ?? false)
                                  ? Image.network(
                                      song.coverUrl!,
                                      width: 260,
                                      height: 260,
